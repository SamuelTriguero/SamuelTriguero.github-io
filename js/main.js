...
const commandMap = {
  ...
  social: "social",
  email: "email",
  globalthermalnuclearwar: "globalthermalnuclearwar",
  history: "history",
  sudo: "sudo",
  clear: "clear",
  github: "github",
...
function enterKey(e) {
  ...
  if (e.keyCode === 13) {
    ...
    addLine("[S4ML@archBTW]~$" + command.innerHTML, "no-animation", 0);
...
function commander(cmd) {
  switch (cmd.toLowerCase()) {
    ...
    case "games":
      ...
      break;  
    case "globalthermalnuclearwar":
      loopLines(globalthermalnuclearwar, "color2 margin", 80);
      break; 
    case "history":
      addLine("<br>", "", 0);
    ...
    case "email":
      addLine(
        'Opening mailto:<a href="mailto:"> </a>...',
        "color2",
        80,
      );
      newTab(email);
    ...
    case "sudo":
      ...
      break;
    case "archive":
      addLine("accessing the archive...", "color2", 0);
      newTab(archive);
      break;
    case "snake":
      runSnakeGame();
